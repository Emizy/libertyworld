...
<div class="container">
  ...
  @if(session('response'))
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #70389C; color: white;">::UPLOAD NECO GCE CARDS</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('UploadNecoGCE') }}">
                        {{ csrf_field() }}
