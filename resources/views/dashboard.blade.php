...
<!-- Mirrored from jituchauhan.com/borrow/bootstrap-4/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2019 19:04:05 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-3 col-sm-6 col-6">
                        <!-- logo -->
                        <div class="logo">
                            <a href="index.html"><img src="images/logo-bank.png" alt="Borrow - Loan Company Website Template"></a>
                        </div>
                    </div>
                    <div class="col-xl-8 col-lg-8 col-md-9 col-sm-12 col-12">
                        <div class="quick-info">
                            <span class="mr10">Call: 1-800-123-4567</span>
                            <span class="mr10"><a href="#">ATM & Branches</a></span>
                            <span><a href="#" class="btn btn-default btn-sm">Internet Banking</a></span>
                            <!-- search start-->
                    ...
                    <div class="hero-tab-block">
                        <div class="st-tabs">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="service1">
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <h2 class="text-bold">Get Personal Loan Offers in Minutes</h2>
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                                    <div class="">
                                                        ...
                                                        <select class="wide">
                                                            ...
                                                            <option value="Debt Consolidation">Major Purpose</option>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="service2">
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <h2 class="text-bold">Get Business Loan Offers in Minutes</h2>
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                                    <div class="">
                                                        <label>Loan Purpose</label>
                                                        <select class="wide">
                                                            <option value="Select Loan Purpose">Select Loan Purpose</option>
                                                            <option value="Debt Consolidation">Business Purpose</option>
                                                            <option value="Major Purpose">Major Purpose</option>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="service3">
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <h2 class="text-bold">Get Home Loan Offers in Minutes</h2>
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                                    <div class="">
                                                        <label>Loan Purpose</label>
                                                        <select class="wide">
                                                            <option value="Select Loan Purpose">Select Loan Purpose</option>
                                                            <option value="Select your personal">Home Buying</option>
                                                            <option value="Select your personal">Home Improevement</option>
                                                            <option value="Select your personal">Moving Relocation</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt30 nopl nopr">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="service4">
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <h2 class="text-bold">Get Car Loan Offers in Minutes</h2>
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                                    <div class="">
                                                        <label>Loan Purpose</label>
                                                        <select class="wide">
                                                          <option value="Select Loan Purpose">Select Loan Purpose</option>
                                                            <option value="Car Loan">Car Loan</option>
                                                             <option value="Vehical Claim">Vehical Claim</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt30 nopl nopr">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="service5">
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <h2 class="text-bold">Get Education Loan Offers in Minutes</h2>
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                                    <div class="">
                                                        <label>Loan Purpose</label>
                                                        <select class="wide">
                                                         ...
                                                         <option value="Education Loan">Pursuing Study  </option>
                                                         <option value="Education Loan">Private Student Loan  </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt30 nopl nopr">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="service6">
                                    <div class="loan-form">
                                        <form>
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <h2 class="text-bold">Get Credit Card Loan Offers in Minutes</h2>
                                                </div>
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                                    <div class="">
                                                        <label>Loan Purpose</label>
                                                        <select class="wide">
                                                          <option value="Select Loan Purpose">Select Loan Purpose</option>
                                                            <option value="Select your personal">Credit Card Consolidation</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt30 nopl nopr">
                                                    <a href="#" class="btn btn-default">get your loan</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-1" data-toggle="tab" href="#service1" role="tab" aria-controls="responsibilities" aria-selected="true"><i class="fa fa-money fa-lg"></i><p>  Personal</p>
                                      </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-2" data-toggle="tab" href="#service2" role="tab" aria-controls="education" aria-selected="false"><i class="fa fa-briefcase fa-lg"></i><p>Business</p></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-3" data-toggle="tab" href="#service3" role="tab" aria-controls="experience" aria-selected="false"><i class="fa fa-home fa-lg"></i><p>Home</p></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-4" data-toggle="tab" href="#service4" role="tab" aria-controls="tab-4" aria-selected="false"><i class="fa fa-car fa-lg"></i><p>Car</p></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-5" data-toggle="tab" href="#service5" role="tab" aria-controls="tab-4" aria-selected="false"><i class="fa fa-graduation-cap fa-lg"></i><p>Education</p></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-6" data-toggle="tab" href="#service6" role="tab" aria-controls="tab-4" aria-selected="false"><i class="fa fa-credit-card fa-lg"></i><p>Credicard</p></a>
                                </li>
                            </ul>
                            <!-- Tab panes -->
                        </div>
...
<!-- Mirrored from jituchauhan.com/borrow/bootstrap-4/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2019 19:04:18 GMT -->
</html>