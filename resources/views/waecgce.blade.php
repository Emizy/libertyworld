                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between bg-important">
                                    <div class="text-success">
                                        ...
                                        <H4>Card-Name : NECO GCE TOKEN CARD </H4>
                                    </div>
                                    <span class="text-success"><strong>Total-Bill: #{{ Session::get('card_amount') }}</strong></span><br>
                                    <small><strong>Note: Your PIN and SERIAL will be generated for you after payment which you will used to check your NECO GCE RESULT.</strong></small>
                                </li>
                            </ul>
                    ...
                    <form method="POST" action="{{ route('pay') }}" accept-charset="UTF-8" class="form-horizontal" role="form">
                        <div class="row" style="margin-bottom:40px;">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <input type="hidden" name="metadata" value="{{ json_encode($array = ['ref_id'=> Session::get('ref_id'),'year' => Session::get('year'),'type'=> 'WAECGCE','price'=>Session::get('card_amount')]) }}" > {{-- For other necessary things you want to add to your payload. it is optional though --}}
