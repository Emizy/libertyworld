...
<ul class="nav nav-tabs nav-justified md-tabs indigo" id="myTabJust" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab-just" data-toggle="tab" href="#home-just" role="tab" aria-controls="home-just"
      aria-selected="true"><h2 style="color: #83bcfa;">LOGIN</h2></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="profile-tab-just" data-toggle="tab" href="#profile-just" role="tab" aria-controls="profile-just"
      aria-selected="false"><h2 style="color: #83bcfa;"> REGISTER</h2></a>
  </li>
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}" >
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input style="margin: 0 auto;display: table;" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> Remember Me
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button style="background-color: #70389C; color: white; margin: 0 auto;display: table;" type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-1a">
                                    LOGIN
                                </button>
...
<div class="row">
    ...
    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
                            <label for="telephone" class="col-md-4 control-label">Phone No:</label>
