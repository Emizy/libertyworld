...
<!-- Mirrored from jituchauhan.com/borrow/bootstrap-4/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Mar 2019 19:09:54 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="row">
                               <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <div class="bg-boxshadow pinside60 outline text-center mb30">
                                        ...
                                        <h2 class="capital-title">Head Office:</h2>
                                        <p>4, Obolo Street, Okitipupa,
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <div class="bg-boxshadow pinside60 outline text-center mb30">
                                        ...
                                        <p>Nazareth Domain Building Along AAUA Small Gate Area,
						   		
                                            <br> Akungba-Akoko, Ondo State. Nigeria.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <div class="bg-boxshadow pinside60 outline text-center mb30">
                                        ...
                                        <h1 class="text-big">+234-813-608-8266 </h1>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <div class="bg-boxshadow pinside60 outline text-center mb30">
                                        ...
                                        <p>libertyprogrammer.com.ng@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
